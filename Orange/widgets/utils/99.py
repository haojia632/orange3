...
class VarTableModel(QAbstractTableModel):
    ...
    def data(self, index, role):
        ...
        b = self.variables[0]
        c = self.variables[0][0]
        a = self.variables[row][0]
